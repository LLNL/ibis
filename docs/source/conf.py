...
latex_documents = [
    ('index', 'uq.tex', 'UQ Methods Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'uq-methods', 'UQ Methods  Documentation',
     author, 1)
]
...
texinfo_documents = [
    ('index', 'uq-methods', 'UQ Methods  Documentation',
     author, 'uq-methods', 'One line description of project.',
     'Miscellaneous'),
]
