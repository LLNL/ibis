...
class TestPlots:
    ...
    def test_likelihood_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'likelihood_plot_01.png',
                                                      self.PRODUCED_DIR + os.sep + 'likelihood_plot_01.png',
                                                      tol=self.tol) == None

        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'likelihood_plot_02.png',
    ...
    def test_box_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'box_plot_01.png',
                                                      self.PRODUCED_DIR + os.sep + 'box_plot_01.png',
                                                      tol=self.tol) == None
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'box_plot_02.png',
    ...
    def test_contour_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'contour_plot_01.png',
                                                      self.PRODUCED_DIR + os.sep + 'contour_plot_01.png',
                                                      tol=self.tol) == None

        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'contour_plot_02.png',
    ...
    def test_scatter_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'scatter_plot_01.png',
                                                      self.PRODUCED_DIR + os.sep + 'scatter_plot_01.png',
                                                      tol=self.tol) == None

        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'scatter_plot_02.png',
    ...
    def test_sensitivity_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'sensitivity_plot_01.png',
    ...
    def test_variance_network_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'variance_network_plot_01.png',
    ...
    def test_rank_order_plot(self):
        ...
        assert matplotlib.testing.compare.compare_images(self.FIDUCIAL_DIR + os.sep + 'rank_order_plot_01.png',
