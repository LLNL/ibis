...
class TestUQMethods(unittest.TestCase):
	...
	def test_kosh_default_mcmc(self):
		...
		post_chain_expected = {'input_A': np.array([0.16435425, 0.16435425, 0.16435425, 0.16435425, 0.11053923,
	...
	def test_kosh_discrepancy_mcmc(self):
		...
		result = kosh_operators.KoshMCMC(self.dataset["inputs"],
										 ...
										 seed=self.seed,
										 flattened=False)[:]
		prior_chains_expected = {'input_A': np.array([[0.46345716, 0.50974877, 0.63393836, 0.63393836, 0.71894928,
		...
		result2 = kosh_operators.KoshMCMC(self.dataset["inputs"],
										 ...
										 seed=self.seed,
										 flattened=True)[:]
		posterior_chains_expected = {'input_A': np.array([0.17669621, 0.17669621, 0.3008858 , 0.40131393, 0.40131393,
